...
tf.flags.DEFINE_integer("log-episode-stats-every-nth", 5, "Print stats of episode every nth")
...
tf.flags.DEFINE_float("supervised-param-mult", 0, "multiplier used by supervised parameter loss")
...
def parse_flags():
    ...
    if FLAGS.rp_save_path is not None:
        FLAGS.rp_save_path = mkdir_p(FLAGS.replay_dir + FLAGS.rp_save_path)
